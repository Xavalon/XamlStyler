...
namespace Xavalon.XamlStyler.Core.Options
{
    public class StylerOptions : IStylerOptions
    {
        ...
        [DefaultValue(new[]
        {
            ...
            "Width, Height, WidthRequest, HeightRequest, MinWidth, MinHeight, MinimumWidthRequest, MinimumHeightRequest, MaxWidth, MaxHeight",
            "Margin, Padding, HorizontalAlignment, VerticalAlignment, HorizontalContentAlignment, VerticalContentAlignment, HorizontalOptions, VerticalOptions, Panel.ZIndex",
            "*:*, *",
